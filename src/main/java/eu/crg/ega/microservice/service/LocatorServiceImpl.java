...
import eu.crg.ega.microservice.exception.ServiceNotFoundException;
...
public class LocatorServiceImpl implements LocatorService {
  ...
  private List<ServiceLocation> getServices() {
    ...
    Base<ServiceLocation> result =
        restSender.sendMicroservice(CONFIG_URL + "/services/", HttpMethod.GET, null, null,
   ...
   */
  @CacheEvict(value = {"serviceURL", "serviceByVersionURL"}, allEntries = true)
  public void resetAllEntries() {
    // Intentionally blank
  }

  @Override
  @Cacheable(value = "serviceByVersionURL")
  ...
  public String getServiceUrlById(String serviceId) {
    String url = null;
    Base<ServiceLocation> result =
        restSender.sendMicroservice(CONFIG_URL + "/services/" + serviceId, HttpMethod.GET,
